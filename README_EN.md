...
[![Version](https://img.shields.io/badge/version-5.0.2-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **v5.0.2 New** — Panel one-click self-update (China CDN acceleration), OpenClaw version detection enhanced (8 detection methods). [View changelog](changelogs/v5.0.2.md)
