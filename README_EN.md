...
[![Version](https://img.shields.io/badge/version-5.2.14-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **v5.2.14 Update** — fixes skill install ownership issues, improves session-driven activity views, tightens WeCom channel state handling, and continues localizing the Agents page. See [changelogs/v5.2.14.md](changelogs/v5.2.14.md)
