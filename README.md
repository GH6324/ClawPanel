...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.10` 继续收口发布链路与 Gitee 同步；`ClawPanel Lite v0.1.10` 修复 fresh Linux Lite 安装后 OpenClaw / 网关离线的问题，并继续推进 Windows / macOS 预览打包。详见 [changelogs/v5.2.10.md](changelogs/v5.2.10.md) 和 [changelogs/lite-v0.1.10.md](changelogs/lite-v0.1.10.md)
