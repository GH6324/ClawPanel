...
[![Pro](https://img.shields.io/badge/Pro-5.2.14-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
[![Lite](https://img.shields.io/badge/Lite-0.1.14-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新发布** — `ClawPanel Pro v5.2.14` 与 `ClawPanel Lite v0.1.14` 已发布；若一键安装/手动更新没有拿到最新版，请优先重新拉取安装脚本或检查加速服务器元数据是否已同步。
