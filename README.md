...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.8` 补强 macOS OpenClaw 探测、受管工作区兼容与 MiniMax 默认配置；`ClawPanel Lite v0.1.5` 继续推进 Windows / macOS Lite 打包脚手架，并为 GitHub Actions 原生构建做准备。详见 [changelogs/v5.2.8.md](changelogs/v5.2.8.md) 和 [changelogs/lite-v0.1.5.md](changelogs/lite-v0.1.5.md)
